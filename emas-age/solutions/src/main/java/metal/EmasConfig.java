...
public class EmasConfig {
    ...
    public static boolean ELITISM_SWITCH = config.getBoolean("ELITISM_SWITCH");
    ...
    public static int ELITISM_PREDICATE = config.getInt("ELITISM_PREDICATE");
    ...
    public static int mutationNumber = config.getInt("mutationNumber");
    public static int iterationsNumber = config.getInt("iterationsNumber");
    public static int initialAgentsNumber = config.getInt("initialAgentsNumber");
    public static int islandsNumber = config.getInt("islandsNumber");
    public static int eliteIslandsNumber = config.getInt("eliteIslandsNumber");
